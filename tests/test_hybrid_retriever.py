...
def test_retrieve_context_only_queries_prices_for_coin_entities(mocker):
    ...
    mocker.patch("rag_src.retrieval.hybrid_retriever.search_similar", return_value=fake_documents)
    ...
    mocker.patch("rag_src.retrieval.hybrid_retriever.psycopg.connect", return_value=fake_conn)
